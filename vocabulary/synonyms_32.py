synonyms = {
    ...
    "platypus": ["duck-billed platypus", "duckbill", "duckbilled platypus", "ornithorhynchus anatinus"],
    ...
    "play back": ["replay"],
    "playbox": ["play-box"],
    "playboy": ["corinthian", "man-about-town"],
    "player": ["participant"],
    "playfulness": ["fun"],
    ...
    "plug": ["secure", "stop up"],
    "plug away": ["keep one's nose to the grindstone", "keep one's shoulder to the wheel", "peg away", "slog"],
    ...
    "pocketbook issue": ["bread-and-butter issue"],
    ...
    "pond": ["pool"],
    "pond apple": ["annona glabra", "pond-apple tree"],
    ...
    "pontus": ["pontos"],
    "pony": ["crib", "trot"],
    "pony cart": ["donkey cart", "ponycart", "tub-cart"],
    "pooch": ["pooch out"],
    "poodle": ["poodle dog"],
    ...
    "porkfish": ["anisotremus virginicus", "pork-fish"],
    "porkpie": ["porkpie hat"],
    ...
    "port": ["port wine"],
    "port jackson fig": ["botany bay fig", "ficus rubiginosa", "little-leaf fig", "rusty rig"],
    ...
    "positive pole": ["north-seeking pole", "positive magnetic pole"],
    ...
    "post-office box": ["call box", "letter box", "po box", "pob"],
    "post-office box number": ["box number", "po box no", "po box number"],
    "postage": ["postage stamp", "stamp"],
    "postal clerk": ["mail clerk"],
    "postbox": ["letter box", "mailbox"],
    "postcard": ["mailing-card", "post card", "postal card"],
    "postdate": ["follow"],
    "postdoc": ["post doc"],
    ...
    "potassium chloride": ["k-dur 20", "k-lor", "k-lyte", "kaochlor", "klorvess", "potash muriate", "potassium muriate"],
    ...
    "prairie bird's-foot trefoil": ["compass plant", "lotus americanus", "prairie lotus", "prairie trefoil"],
    ...
    "prairie mimosa": ["desmanthus ilinoensis", "prickle-weed"],
    "prairie orchid": ["habenaria leucophaea", "prairie white-fringed orchis"],
    ...
    "prankster": ["cut-up", "hoaxer", "practical joker", "tricker", "trickster"],
    "praseodymium": ["atomic number 59", "pr"],
    ...
    "prickly poppy": ["argemone", "devil's fig", "white thistle"],
